...
def get_graph_store():
    return CustomNeo4jGraphStore(
        ...
        url="neo4j+s://b9fd4088.databases.neo4j.io",
        database="neo4j",
        node_label="S_PHENOTYPE",
        #schema_cache_path="/schema_cache.txt",
    )


#def get_retriever_pipeline(callback_manager: CallbackManager | None = None, llm_model_name: str = "llama3:8b-instruct-q5_K_M"):
def get_retriever_pipeline(callback_manager: Union[CallbackManager, None] = None, llm_model_name: str = "groq:Llama-3.3-70b-Versatile"):
...
def get_pipeline(callback_manager: Union[CallbackManager, None] = None, llm_model_name: str = "groq:Llama-3.3-70b-Versatile"):
    ...
    if llm_model_name.startswith("starling-lm"):
        ...
        CUSTOM_CONTEXT_PROMPT_TEMPLATE = (
            "You are a professional scientific communicator that helps inform people about clinical metabolomics in an easy to "
...
def get_llm(llm_model_name: str = "groq:Llama-3.3-70b-Versatile"):
...
def get_retriever(
    ...
    CUSTOM_QUERY_KEYWORD_EXTRACT_TEMPLATE_TMPL = (
        'Return a comma-separated list of scientific entities mentioned in the question.\n'
        'QUESTION: {question}\n'
        'ENTITIES: '
    )
