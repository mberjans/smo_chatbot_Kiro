...
class CustomNeo4jGraphStore(Neo4jGraphStore):
    ...
    def get_rel_map(
        self, subjs: Union[List[str], None] = None, depth: int = 2, limit: int = 30
    ...
    def get_rel_map_organization(self, subjs: Union[List[str], None] = None, limit: int = 30) -> Dict[str, List[List[str]]]:
        if subjs is None or len(subjs) == 0:
            return {}
    ...
    def get_rel_map_phenotype(self, subjs: Union[List[str], None] = None, limit: int = 30):
        if subjs is None or len(subjs) == 0:
            return {}
    ...
    def get_rel_map_prevalence(self, subjs: Union[List[str], None] = None, limit: int = 30) -> Dict[str, List[List[str]]]:
        if subjs is None or len(subjs) == 0:
            return {}
    ...
    def get_rel_map_pubtator3(self, subjs:Union[List[str], None] = None, limit: int = 30) -> Dict[str, List[List[str]]]:
        if subjs is None or len(subjs) == 0:
            return {}
